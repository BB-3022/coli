...
<body>
    ...
    <div class="container">
      ...
      <h1 class="text-center pricing-table-title">내 요금제 : ${user.member.getRole()}</h1>

      <div class="row">
		 <c:choose>
		    <c:when test="${user.member.getRole().name() == 'FREE'}">
		        <!-- 기본 요금제 내용 표시 -->
		        <div class="col-md-4">
		          <div class="card pricing-card pricing-plan-basic">
		            <div class="card-body">
		              ...
		              <a href="${cpath}/plan" class="btn pricing-plan-purchase-btn">Change Plan</a>
		            </div>
		          </div>
		        </div>
		    </c:when>
		    <c:when test="${user.member.getRole().name() == 'STANDARD'}">
		        <!-- 표준 요금제 내용 표시 -->
		        <div class="col-md-4">
		    ...
		    <c:when test="${user.member.getRole().name() == 'PRIMIUM'}">
		        <!-- 프리미엄 요금제 내용 표시 -->
		        <div class="col-md-4">
