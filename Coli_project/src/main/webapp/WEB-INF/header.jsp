...
<body>
            ...
            <div class="row p-4 p-md-0 flex-column-reverse flex-md-row g-md-5 nav__block">
               <div class="col-md-5">
                  <ul class="nav__list d-none d-md-block">
                     <li class="nav__list-item"><a href="${cpath}/" class="hover-target">Home</a>
                     </li>
                     <c:if test="${not empty user}">
                        <li class="nav__list-item"><a href="${cpath}/member/logout" class="hover-target">Logout</a></li>
                     </c:if>
                     ...
                     <li class="nav__list-item"><a href="${cpath}/draw2" class="hover-target">Draw</a></li>
                     <li class="nav__list-item"><a href="${cpath}/board/gallery" class="hover-target">Gallery</a></li>
                  </ul>
               </div>
               <div class="col-md-4 text-white">
                  ...
                  <ul class="list-unstyled text-light nav__block-item">
                     <li><a href="${cpath}/draw2" class="text-white">AI Draw - 클릭형</a></li>
                     <li><a href="${cpath}/draw3" class="text-white">AI Draw - 이미지업로드</a></li>
                     <li><a href="${cpath}/draw4" class="text-white">AI Draw - 실시간 영상촬영</a></li>
                  </ul>
               </div>
      ...
      <form id="app-cover">
        <div id="select-box">
          ...
          <div id="select-button" class="brd">
            ...
            <c:if test="${not empty user}">
             <p>안녕하세요, <c:out value="${user.member.username}"/>님!</p>
           </c:if>
   ...
   document.addEventListener("DOMContentLoaded", function () {
       ...
       function redirectToPage(value) {
           switch (value) {
               case "codepen":
                   window.location.href = "${cpath}/member/mypage";
                   break;
               case "dribbble":
                   window.location.href = "${cpath}/member/modify";
                   break;
               case "behance":
                   window.location.href = "${cpath}/mygallery/{username}";
                   break;
               case "hackerrank":
                   window.location.href = "${cpath}/member/myplan";
                   break;
               // 다른 옵션에 대한 처리를 추가할 수 있습니다.
               default:
                   break;
           }
       }
